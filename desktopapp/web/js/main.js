...
document.getElementById("button-mine").addEventListener(
  "click",
  () => {
    eel.get_mana_bar();
...
document.getElementById("button-acc").addEventListener(
  "click",
  () => {
    eel.get_mana_bar();
    window.location.replace("altmanager.html");
  },
  false
);
document.getElementById("button-mana").addEventListener(
  "click",
  () => {
    eel.get_mana_bar();
    window.location.replace("mana_bar.html");
  },
  false
);
document.getElementById("button-cd").addEventListener(
  "click",
  () => {
    eel.get_mana_bar();
    window.location.replace("cooldown.html");
  },
  false
);
document.getElementById("button-counter").addEventListener(
  "click",
  () => {
    eel.get_mana_bar();
